        ...
        mRecyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
                ...
                if (onBannerPageChangeListener != null) {
                    onBannerPageChangeListener.onScrollStateChanged(recyclerView, newState);
                    if (count != 0)
                        onBannerPageChangeListener.onPageSelected(position % count);
                }
            }
            ...
            public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                ...
                if (onBannerPageChangeListener != null)
                    onBannerPageChangeListener.onScrolled(recyclerView, dx, dy);
