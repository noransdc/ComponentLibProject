package com.intertive.banner.view;
...
public class CBLoopViewPager extends RecyclerView {
    ...
    private static final float FLING_SCALE_DOWN_FACTOR = 0.2f; // 减速因子
    private static final int FLING_MAX_VELOCITY = 1500; // 最大顺时滑动速度
    private static boolean mEnableLimitVelocity = false; // 最大顺时滑动速度
