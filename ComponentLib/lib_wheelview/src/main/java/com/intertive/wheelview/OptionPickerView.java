...
import com.intertive.wheelview.listener.OnOptionSelectedListener;
 ...
 * @since 2018/8/21.
 */
public class OptionPickerView<T> extends LinearLayout implements WheelView.OnItemSelectedListener<T>,
    ...
    private OnOptionSelectedListener<T> mOnOptionsSelectedListener;
    ...
    public OptionPickerView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public OptionPickerView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
     ...
     */
    public void setOnOptionsSelectedListener(OnOptionSelectedListener<T> onOptionsSelectedListener) {
