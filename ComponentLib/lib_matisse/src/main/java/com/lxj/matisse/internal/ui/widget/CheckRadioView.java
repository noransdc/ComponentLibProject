...
//                getContext().getTheme());
        mSelectedColor = ContextCompat.getColor(getContext(), R.color.zhihu_item_checkCircle_backgroundColor);
//        mUnSelectUdColor = ResourcesCompat.getColor(
//                getResources(), R.color.zhihu_check_original_radio_disable,
//                getContext().getTheme());
        mUnSelectUdColor = ContextCompat.getColor(getContext(), R.color.zhihu_check_original_radio_disable);
        setChecked(false);
    }
