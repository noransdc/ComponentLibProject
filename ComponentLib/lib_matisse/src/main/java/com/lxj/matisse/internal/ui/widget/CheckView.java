...
public class CheckView extends View {
    ...
    private void init(Context context) {
        ...
        int defaultColor = ContextCompat.getColor(context, R.color.zhihu_item_checkCircle_borderColor);
...
//                R.drawable.ic_check_white_18dp, context.getTheme());
        ...
        mCheckDrawable = ContextCompat.getDrawable(context, R.drawable.ic_check_white_18dp);
    }
