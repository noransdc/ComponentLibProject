...
public class RoundImageView extends AppCompatImageView {
    ...
    private void init(@NonNull Context context, AttributeSet attrs) {
        ...
        cornerRadius = typedArray.getDimensionPixelSize(R.styleable.RoundImageView_riv_radius, 0);
        topLeftRadius = typedArray.getDimensionPixelSize(R.styleable.RoundImageView_riv_radius_top_left, 0);
        topRightRadius = typedArray.getDimensionPixelSize(R.styleable.RoundImageView_riv_radius_top_right, 0);
        botLeftRadius = typedArray.getDimensionPixelSize(R.styleable.RoundImageView_riv_radius_bottom_left, 0);
        botRightRadius = typedArray.getDimensionPixelSize(R.styleable.RoundImageView_riv_radius_bottom_right, 0);
        isBorderOver = typedArray.getBoolean(R.styleable.RoundImageView_riv_border_over, false);
        borderWidth = typedArray.getDimension(R.styleable.RoundImageView_riv_border_width, 0);
        borderColor = typedArray.getColor(R.styleable.RoundImageView_riv_border_color, 0x60ffffff);
